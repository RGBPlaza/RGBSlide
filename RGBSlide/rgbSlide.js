(function ($) {
    $.fn.rgbslide = function (slideInterval) {
        ...
        $("head").prepend('<style>.sliderBox{background-color:#222;z-index:-1;margin:0;position:absolute;left:0;top:0;width:100%;height:80vh;transition:filter,-webkit-filter 0.7s;}'
        ...
        $("#sl1").css("z-index", "1");
        $("#sl1").css("-webkit-filter", "blur(0px)");
        $("#sl1").css("filter", "blur(0px)");
        $("#sb1").css("color", "#fff");
        ...
        $("#sliderLeft").click(function () {
            ...
            $(".sliderBox").css("filter", "blur(8px)");
            $(".sliderBox").css("-webkit-filter", "blur(8px)");
            ...
            $("#sl" + slideNum).css("filter", "blur(0px)");
            $("#sl" + slideNum).css("-webkit-filter", "blur(0px)");
        ...
        $("#sliderRight").click(function () {
            ...
            if (slideNum == 1) {
                ...
                $("#sl" + numSlides).css("filter", "blur(0px)");
                $("#sl" + numSlides).css("-webkit-filter", "blur(0px)");
                $("#sl1").css("z-index", "1");
                $("#sl" + numSlides).animate({ left: "-100%" }, 500);
                $("#sb1").css("color", "#fff");
            } else {
                $("#sl" + (slideNum - 1)).css("filter", "blur(0px)");
                $("#sl" + (slideNum - 1)).css("-webkit-filter", "blur(0px)");
        ...
        $(".sliderBull").click(function () {
            ...
            if (bullNum != slideNum - 1) {
                ...
                $("#sl" + bullNum).css("z-index", "2");
                $("#sl" + bullNum).css("filter", "blur(0px)");
                $("#sl" + bullNum).css("-webkit-filter", "blur(0px)");
